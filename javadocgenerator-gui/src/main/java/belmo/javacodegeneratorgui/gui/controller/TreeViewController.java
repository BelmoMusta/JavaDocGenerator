...
import belmo.javacodegeneratorgui.gui.PropertiesGUI;
import belmo.javacodegeneratorgui.gui.controls.CustomButton;
import belmo.javacodegeneratorgui.gui.controls.MenuAction;
import belmo.javacodegeneratorgui.gui.controls.MenuItemWithIcon;
...
public class TreeViewController implements ControllerConstants {
    ...
    private void setUpIconsBar() {
        ...
        VBox vBox = CodeUtils.castTo(root.getTop());
    ...
    private void saveFileAs() {
        ...
        if (content != null) {
            ...
            try {
                if (destFile != null) {
                    CodeUtils.saveToFile(text.getBytes(), destFile);
