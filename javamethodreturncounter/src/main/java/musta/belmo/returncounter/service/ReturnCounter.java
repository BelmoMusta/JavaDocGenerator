...
public class ReturnCounter {
    ...
    /**
     * @param src {@link File}
     * @return Attribut {@link #javaFilesInDir}
     */
    ...
    private Set<MethodDescriber> countReturnStmtByMethod(File src) throws IOException {
        ...
        compilationUnit.findAll(MethodDeclaration.class, methodDeclaration -> methodDeclaration.getParentNode().isPresent() && !(methodDeclaration.getParentNode().get() instanceof ObjectCreationExpr)).forEach(methodDeclaration -> {
    ...
    /**
     * @param methodDescribers {@link Collection}
     ...
     * @return Attribut {@link #signature}
     */
